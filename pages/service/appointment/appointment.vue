<template>
	<view class="container">
		...
		<view class="container_1">
			...
			<div class="wrapper_2">
				<div class="group_2">
					<div class="nickname" :index="25">
						<span style="color: red;">*</span>
						<span style="color: black;">姓名</span>
					</div>
					<input v-model="baseFormData.name" @focus="clearPlaceholder" @blur="showPlaceholder"
						:placeholder="placeholderName" class="nickname_next" type="text" />
				</div>
				<image class="divider" :index="23" src="/static/images/images-point/img_8.png" />
				<div class="group_3">
					<div class="nickname_1" :index="25">
						<span style="color: red;">*</span>
						<span style="color: black;">年龄</span>
					</div>
					<input v-model="baseFormData.age" @focus="clearPlaceholder" @blur="showPlaceholder"
						:placeholder="placeholderAge" class="nickname_next_1" type="text" />
				</div>
			</div>
			<div class="wrapper_3">
				<image class="divider_1" :index="20" src="/static/images/images-point/img_9.png" />
				<div class="group_4">
					<div class="nickname_2" :index="25">
						<span style="color: red;">*</span>
						<span style="color: black;">性别</span>
					</div>
					<div class="view_2">
						<input v-model="baseFormData.sex" @focus="clearPlaceholder" @blur="showPlaceholder"
							:placeholder="placeholderSex" class="caption_1" type="text" />
...
<!-- 			<image class="divider_2" :index="15" src="/static/images/images-point/img_11.png" />
			<div class="wrapper_4">
				<div class="nickname_3" :index="25">
					<span style="color: red;">*</span>
					<span style="color: black;">地址</span>
				</div>
				<input v-model="baseFormData.address" @focus="clearPlaceholder" @blur="showPlaceholder"
					:placeholder="placeholderAddress" class="nickname_next_3" type="text" />
			...
			<div class="wrapper_5">
				<div class="group_5">
					<div class="nickname_4" :index="25">
						<span style="color: red;">*</span>
						<span style="color: black;">详细地址</span>
					</div>
					<input v-model="baseFormData.addressdtails" @focus="clearPlaceholder" @blur="showPlaceholder"
						:placeholder="placeholderAdressDtail" class="nickname_next_2" type="text" />
				</div>
				<image class="divider_4" :index="10" src="/static/images/images-point/img_14.png" />
			</div>
			<div class="wrapper_6">
				<div class="group_6">
					<div class="nickname_5" :index="25">
						<span style="color: red;">*</span>
						<span style="color: black;">联系电话</span>
					</div>			
					<input v-model="baseFormData.phoneNum" @focus="clearPlaceholder" @blur="showPlaceholder"
						:placeholder="placeholderPhone" class="nickname_next_3" type="text" />
				</div>
				<image class="divider_5" :index="7" src="/static/images/images-point/img_15.png" />
			</div>
			<div class="wrapper_7">
				<div class="group_7">
					<div class="nickname_6" :index="25">
						<span style="color: red;">*</span>
						<span style="color: black;">身份证</span>
					</div>
					<input v-model="baseFormData.sfid" @focus="clearPlaceholder" @blur="showPlaceholder"
						:placeholder="placeholderSfid" class="nickname_next_4" type="text" />
				</div>
				<image class="divider_6" :index="4" src="/static/images/images-point/img_16.png" />
				<div class="group_8">
					<div class="caption_2" :index="25">
						<span style="color: red;">*</span>
						<span style="color: black;">预约时间</span>
					</div>
					<div class="view_3">
						<uni-datetime-picker class="title_2" type="datetime" return-type="timestamp"
...
1.预约成功后个人原因取消订单，將收取30%的服务贾。2.如需修改请提前3小时通知护士，护士出发后取消订单將收取70%的服务贾。
			...
			<div class="footer" :index="1">
				<text class="confirm" @click="submit('baseForm')">确定预约</text>
	...
	export default {
		data() {
			return {
				...
				placeholderSfid: "请输入身份证",
				placeholderAge: "请输入年龄",
				placeholderSex: "男",
				// placeholderAdress: "请输入地址",
				placeholderAdressDtail: "请输入详细地址门牌号",
				placeholderPhone: "请输入电话",
				// placeholderContact: "请输入紧急联系电话",
		...
		methods: {
			clearPlaceholder() {
				const placeholders = {
					...
					sfid: this.placeholderSfid,
					age: this.placeholderAge,
					sex: this.placeholderSex,
					address: this.placeholderAdress,
					addressdtails: this.placeholderAdressDtail,
					phoneNum: this.placeholderPhone,
					// contact: this.placeholderContact,
				};

				for (const key in placeholders) {
					if (this.baseFormData[key] === placeholders[key]) {
						this.baseFormData[key] = ''; // 清空输入框内容
					}
				}
			},
			...
			showPlaceholder() {
				...
				for (const key in placeholders) {
					if (!this.baseFormData[key]) {
						this.baseFormData[key] = placeholders[key]; // 显示占位符
					}
				}
			},
			...
			submit(ref) {
				...
				if (
					...
					!this.baseFormData.age ||
					!this.baseFormData.sex ||
					!this.baseFormData.addressdtails ||
				...
				let orderData = {}; {
					orderData.title = this.taocan,
						...
						orderData.servants_address = this.baseFormData.addressdtails,
