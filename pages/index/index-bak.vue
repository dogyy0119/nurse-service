			...
			<div v-if="projectList.length > 0" class="mod">
				<div class="body-2">
					<div class="wrapper-list" :index="4">
						...
						<div class="group-item-list" :index="4">
...
<style>
	...
	.mod {
		...
		padding: 0 12rpx;
		/*小人图片*/
		/* background-image: url(/static/images/images-home/img_22.png); */
	...
	.wrapper-list {
		...
		/* 	background-size: 100% 100%;
		background-repeat: no-repeat;
		background-position: 0 1100rpx;
		box-sizing: border-box;
		background-origin: padding-box;
		background-image: url(/static/images/images-home/img_5-bottom.png); */
	}
