	...
	<view class="content">
		...
		<view>
			<div v-for="index in Math.ceil(serviceKinds.length / 4)" :key="index" class="body">
			    <div class="wrapper-2">
			        <div v-if="serviceKinds.length > 0" class="group">
			        ...
			        <div v-if="serviceKinds.length > 1" class="group-1">
			    ...
			    <div class="wrapper-3">
			        <div v-if="serviceKinds.length > 2" class="group-2">
			        ...
			        <div v-if="serviceKinds.length > 3" class="group-3">
