					...
					<div class="wrapper-list" :index="4">
						...
						<div v-for="(item, mindex) in projectList" :key="mindex" class="group-item-0-list" >
							...
							<div class="view-list" :index="1">
								<text v-if="true" class="detail-list" :index="0">查看详情 </text>
							</div>
						</div>
						<!-- <div v-if="true" class="group-item-1-list" :index="0">
							<text class="item-title-1-list" :index="1">心理治疗 </text> <text class="price-1" :index="0">￥120.00
							</text>
							<image class="entry-pic-1-list" :index="0" src="@/static/images/images-list/img_1.png" />
							<div class="view-1-list" :index="1"><text v-if="true" class="detail-1" :index="0">查看详情 </text>
							</div>
						</div> -->
					</div>
				</div>
